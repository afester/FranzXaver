...
class TextStyle {
    ...
    private TextStyle(List<String> newStyles) {
        styles = newStyles;
    }
    ...
    public static final Codec<TextStyle> CODEC = new Codec<TextStyle>() {
        ...
        public void encode(DataOutputStream os, TextStyle s)
                throws IOException {
            System.err.println("ENCODE STYLE");
        }
...
//        }
        ...
        public TextStyle decode(DataInputStream is) throws IOException {
            System.err.println("DECODE STYLE");
...
//    public static TextStyle addStyle(String style) { return EMPTY.}
//
...
//
        return styles.toString(); // "[" + String.join(",", styles) + "]";
    }
//
//    public String toCss() {
...
//
    ...
    public boolean contains(String style) {
        boolean result = styles.contains(style);
        System.err.printf("%s contains %s : %s%n", styles, style, result);
...
//    }
    ...
    public TextStyle updateWith(String style, boolean addIt) {
        ...
        return new TextStyle(newStyles);
    }
}